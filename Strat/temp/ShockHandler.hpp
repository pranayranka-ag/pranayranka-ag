...
public:
  ...
  std::vector<long double> portfolio_risk{9,0};
  std::vector<double> spot_moves{0, 0.02,-0.02};
  std::vector<double> iv_moves{0,0.05,-0.05};
  ...
  ShockHandler(int date, uint64_t timestamp_t, uint64_t unit_time_t, std::map<int, Tim::TradeVals> *tradeBook_t,
      ...
      Tim::MarginStats *margin_stats_t, std::string filepath_t,
